...
class _HomePageState extends State<HomePage> {
  ...
  Widget _horizontalRow({
    ...
    final displayList = _series.isNotEmpty ? _series : List.generate(5, (i) => null);
    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (ctx, i) {
          ...
          final badge = item != null && item['category'] != null
              ? item['category']
  ...
  Widget _allShowsGrid() {
    ...
    final displayList = _series.isNotEmpty ? _series : List.generate(8, (i) => null);
    ...
    return Padding(
      ...
      child: GridView.builder(
        ...
        itemBuilder: (gridCtx, i) {
          final item = displayList[i];
          final imageKey = item != null ? 'assets/series1.png' : 'assets/series${(i % 5) + 1}.png'; // Fallback to asset for now
          ...
          return GestureDetector(
            onTap: () {
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (_) => VideoPlayerPage(
                      assetPath: details['video']!,
                      title: item != null ? item['title'] : details['title']!),
                ),
              );
            },
            child: Container(
      ...
      bottomNavigationBar: Container(
        ...
        child: Row(
          ...
          children: const [
            ...
            _NavItem(icon: Icons.favorite_border, label: 'Shelf'),
