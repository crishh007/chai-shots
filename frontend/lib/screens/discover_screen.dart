...
class _VideoCardState extends State<VideoCard> {
  ...
  void initState() {
    ...
    // Use network controller if it's an HTTP URL (backend data)
    // Otherwise fallback to asset controller (local fallback data)
    ...
    _controller.initialize().then((_) {
      ...
      if (widget.myIndex == 0) {
        ...
        _controller.play().catchError((e) {
          debugPrint("❌ [Video Card] Initial play error: $e");
        });
      ...
      debugPrint("❌ [Video Card] Initialization failed: $e");
    });
  }
